function [stg] = Timing_Model_Modified()
% stg means (settings)
...
% (SBtab excel name)
stg.sbtab_excel_name = "SBtab_Timing_Model_Modified.xlsx";

% Name of the model
% (Name)
stg.name = "Timing_Model_Modified";

stg.plot_name = "Timing_Model_Modified";
...
stg.pa(2,:) = [-7.18925771027837,-6.60715652329060,1,-6.07244788133842,-2.13663144227696,1];
stg.pa(3,:) = [-6.22975891434875,0.294632292511071,-0.622236624983631,-6.06566643551206,-3.42340982611667,0.978214288620154];
stg.pa(4,:) = [-7.17288684132264,-0.659844935614751,0.780553059766909,-6.07100582054756,-0.286254265041144,1.99854128824890];
